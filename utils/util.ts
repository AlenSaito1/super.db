...
export default class Util {
     ...
     * @returns {any[]}
     */
    static sort(key: string, data: any[], ops: any) {
     ...
     * @returns {any}
     */
    static setData(key: string, data: any, value: any) {
     ...
     * @returns {any}
     */
    static unsetData(key: string, data: any) {
        let parsed = this.parseKey(key);
        let item = data;
        if (typeof data === "object" && parsed.target) {
     ...
     * @returns {any}
     */
    static getData(key: string, data: any) {
        let parsed = this.parseKey(key);
